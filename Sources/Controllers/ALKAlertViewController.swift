...
class ALKAlertViewController: UIViewController, Localizable {
    ...
    var  delegate : ALAlertButtonClickProtocol?
    var action : String!
    ...
    private let alertMessageLabel: UILabel = {
        ...
        picker.font = UIFont(name: "HelveticaNeue-Light", size: 14)
    ...
    private lazy var confirmButton: UIButton = {
        ...
        button.setFont(font:font ?? UIFont(name: "Helvetica", size: 14)!)
    ...
    private lazy var  cancelButton: UIButton = {
        ...
        let title = localizedString(forKey: "ButtonCancel", withDefaultValue: SystemMessage.ButtonName.Cancel, fileName: configuration.localizedStringFileName).uppercased()
