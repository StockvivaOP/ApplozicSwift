...
open class ALKReplyMessageView: UIView, Localizable {
    ...
    lazy open var selfNameText: String = {
        let text = ALKConfiguration.delegateSystemInfoRequestDelegate?.getSystemTextLocalizable(key: "chat_common_you") ?? localizedString(forKey: "You", withDefaultValue: SystemMessage.LabelName.You, fileName: configuration.localizedStringFileName)
        return text
    }()
    ...
    open func update(message: ALKMessageViewModel, configuration: ALKConfiguration) {
        ...
        if message.messageType == ALKMessageType.voice  {
            ...
            messageLabel.text = ALKConfiguration.delegateSystemInfoRequestDelegate?.getSystemTextLocalizable(key: "chat_common_audio") ?? messageLabel.text
            ...
            messageLabel.text = ALKConfiguration.delegateSystemInfoRequestDelegate?.getSystemTextLocalizable(key: "chat_common_video") ?? messageLabel.text
            ...
            messageLabel.text = ALKConfiguration.delegateSystemInfoRequestDelegate?.getSystemTextLocalizable(key: "chat_common_photo") ?? messageLabel.text
            ...
            messageLabel.text = ALKConfiguration.delegateSystemInfoRequestDelegate?.getSystemTextLocalizable(key: "chat_common_document") ?? messageLabel.text
        }else{
